...
class OrderHistoryAdapter (val appExecutors: AppExecutors,
    ...
    override fun bind(
        ...
        Timber.i("item = $item")
        item.apply {
            binding.orderId.setText(Integer.toString(id))
            binding.amount.setText(totalAmount)
            binding.date.setText(Integer.toString(orderDate.epochSecond))
